          ...
          <div className="space-y-xl">
            <div>
              ...
              <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
                ...
                <br /><br />
                Lapak Kliwonan lahir dari sebuah gagasan sederhana: bagaimana kami bisa membawa kebaikan alam Desa Kliwonan langsung ke tangan Anda, tanpa perantara yang panjang? Melalui platform ini, kami mewujudkan gagasan tersebut dengan menciptakan jembatan digital yang memberdayakan komunitas lokal.
              </p>
            </div>
