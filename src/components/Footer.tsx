...
export default function Footer({ variant = 'full' }: FooterProps) {
  if (variant === 'simple') {
    return (
      <footer className="mt-auto bg-surface-container-lowest border-t border-outline-variant w-full px-mobile-margin md:px-desktop-margin py-lg flex flex-col md:flex-row justify-between items-center max-w-7xl mx-auto">
  ...
  return (
    <footer className="bg-surface-container-lowest border-t border-outline-variant w-full px-container-margin py-xxl flex flex-col md:flex-row justify-between items-center max-w-7xl mx-auto gap-lg">
      {/* Brand */}
